...
class EsquemaDimensional:
    ...
    CREATE TABLE IF NOT EXISTS fato_combustivel (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        id_equipamento INTEGER,
        litros_estimado DECIMAL(15,2),
        litros_realizado DECIMAL(15,2),
        litros_diferenca DECIMAL(15,2),
        valor_unitario_estimado DECIMAL(15,2),
        valor_unitario_realizado DECIMAL(15,2),
        valor_unitario_diferenca DECIMAL(15,2),
        total_estimado DECIMAL(15,2),
        total_realizado DECIMAL(15,2),
        total_diferenca DECIMAL(15,2),
        data_referencia DATETIME,
